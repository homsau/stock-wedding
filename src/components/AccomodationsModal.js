...
function AccomodationsModal(props) {
    return (
      <Modal
        {...props}
        size="xl"
        ...
        centered
      >
        <Modal.Header className="modal-accomodations" closeButton>
        ...
        <Modal.Body>
          <Container>
            <Row className="justify-content-xl-center">
              ...
              <Col className="modal-reserve-button" style={{textAlign: 'center', marginTop: '20px'}}  xs={12} md={12}>
                <Button style={{fontSize: '1.5rem'}} variant="primary" target="_blank" href="https://www.hyatt.com/en-US/hotel/georgia/hyatt-place-atlanta-duluth-johns-creek/atlzj?corp_id=G-CUCO" className='main_button align-self-center'>
                  <div>
                    Reserve a room!
                  </div>
                </Button>
